...
static constexpr auto qt_meta_stringdata_CLASSApiHandlerENDCLASS = QtMocHelpers::stringData(
    "ApiHandler"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSApiHandlerENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSApiHandlerENDCLASS_t qt_meta_stringdata_CLASSApiHandlerENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10)   // "ApiHandler"
    },
    "ApiHandler"
};
