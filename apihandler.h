...
private:
    ...
    QJsonObject handleSendResetCode(const QJsonObject &data);
    QJsonObject handleResetPassword(const QJsonObject &data);
    QJsonObject handleCheckAccountEmail(const QJsonObject &data);
    ...
    QString getUserSchool(int userId);
    ...
    QJsonObject handleGetCollaborativeRecommendations(int userId, const QJsonObject &data);
    // 商品内容审核
    QJsonObject checkGoodsContent(const QString& name, const QString& description);
